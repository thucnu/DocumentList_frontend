...
const ImportForm = ({ onImported }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 mb-6 max-w-lg mx-auto">
      <h3 className="text-lg font-semibold text-black mb-4">Thêm tài liệu mới</h3>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <select value={group} onChange={(e) => setGroup(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded bg-gray-50">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-red-500 bg-gray-50 text-gray-900"
            ref={fileInputRef}
          />
        </div>
